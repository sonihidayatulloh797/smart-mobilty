...
<body>
    ...
    <div class="content">
        <div class="steps">
            ...
            <a href="{{ route('landing-page2') }}" style="text-decoration: none; color: #000"><div class="step active">2</div></a>
            <a href="{{ route('landing-page3') }}" style="text-decoration: none; color: #000"><div class="step">3</div></a>
